...
const translations = reactive({
  en: {
    ...
    resourceAlertNetIn: 'Download threshold (MB/s)',
    resourceAlertNetOut: 'Upload threshold (MB/s)',
    resourceAlertNetTotal: 'Total network threshold (MB/s)',
    resourceAlertTip: 'Window 0 disables resource load alerts. Threshold 0 disables that metric. DO keeps one sample per server per minute, up to 10 minutes.',
  ...
  zh: {
    ...
    resourceAlertNetIn: '下行阈值 (MB/s)',
    resourceAlertNetOut: '上行阈值 (MB/s)',
    resourceAlertNetTotal: '总网速阈值 (MB/s)',
    resourceAlertTip: '时间窗口为 0 表示关闭资源负载告警；阈值为 0 表示关闭该指标。DO 按每台服务器每分钟缓存一个样本，最多保留 10 分钟。',
