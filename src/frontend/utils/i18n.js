...
const translations = reactive({
  en: {
    ...
    queryD1Quota: 'Query Account D1, Workers & Durable Objects Quota',
    d1UsageQueried: 'D1, Workers & Durable Objects quota query succeeded. Remember to save.',
    d1UsageDate: 'Usage Date',
    d1RowsRead: 'Rows Read',
    d1RowsWritten: 'Rows Written',
    workersRequests: 'Workers Requests',
    durableObjectsRequests: 'Durable Objects Requests',
  ...
  zh: {
    ...
    queryD1Quota: '查询账户 D1、Workers & Durable Objects 用量',
    d1UsageQueried: 'D1、Workers & Durable Objects 用量查询成功，注意保存',
    d1UsageDate: '统计日期',
    d1RowsRead: '已读取行数',
    d1RowsWritten: '已写入行数',
    workersRequests: 'Workers 请求数',
    durableObjectsRequests: 'Durable Objects 请求数',
