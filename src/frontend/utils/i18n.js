...
const translations = reactive({
  en: {
    ...
    trafficReportDaily: 'Daily traffic report',
    trafficReportWeekly: 'Weekly traffic report',
    trafficReportMonthly: 'Monthly traffic report',
    trafficReportTime: 'Traffic report time',
    trafficReportTip: 'Uses lightweight JSON baselines in the notification timezone. Daily reports run every day, weekly reports on Monday, and monthly reports on the first day. The first run only records a baseline.',
  ...
  zh: {
    ...
    trafficReportDaily: '每日流量报告',
    trafficReportWeekly: '每周流量报告',
    trafficReportMonthly: '每月流量报告',
    trafficReportTime: '流量报告时间',
    trafficReportTip: '按通知时区维护轻量 JSON 基线；日报每天发送，周报在周一发送，月报在每月 1 日发送。首次运行只记录基线。',
