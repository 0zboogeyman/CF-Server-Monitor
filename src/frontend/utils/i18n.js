...
const translations = reactive({
  en: {
    ...
    trafficReportTip: 'Uses the notification timezone. Weekly reports are sent on Monday and monthly reports on the first day. The first run records a baseline and sends no report.',
  ...
  zh: {
    ...
    trafficReportTip: '按通知时区发送；周报在周一发送，月报在每月 1 日发送。首次运行只记录基线，不发送报告。',
