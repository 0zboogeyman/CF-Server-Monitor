...
export async function loadSiteSettings(db, options = {}) {
  ...
  try {
    ...
    result.traffic_report_daily = normalizeBooleanSetting(result.traffic_report_daily);
    result.traffic_report_weekly = normalizeBooleanSetting(result.traffic_report_weekly);
    result.traffic_report_monthly = normalizeBooleanSetting(result.traffic_report_monthly);
...
export async function saveSiteOptions(db, updates) {
  ...
  siteOptions.traffic_report_daily = normalizeBooleanSetting(siteOptions.traffic_report_daily);
  siteOptions.traffic_report_weekly = normalizeBooleanSetting(siteOptions.traffic_report_weekly);
  siteOptions.traffic_report_monthly = normalizeBooleanSetting(siteOptions.traffic_report_monthly);
